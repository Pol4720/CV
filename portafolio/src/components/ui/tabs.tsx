...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center rounded-xl bg-white/5 p-1 text-muted-foreground backdrop-blur-sm border border-white/10",
      className
    )}
    {...props}
  />
