...
const img = (slug: string, file: string) => withBasePath(`/projects/${slug}/${file}`);

/* ============================================================
   PRIVATE / PROFESSIONAL PROJECTS
   Work developed at the Finlay Vaccine Institute / BioCubaFarma
   and in clinical research. Shown at a high level, without
   exposing source code or protected data.
   ============================================================ */
export const privateProjects: Project[] = [
  {
    ...
    overview: [
      {
        es: "FinlAI es el núcleo del ecosistema de datos del Instituto Finlay de Vacunas: una plataforma que centraliza, normaliza y explota la información generada durante el ciclo de vida de una vacuna, desde la investigación preclínica hasta el seguimiento posterior al registro.",
        en: "FinlAI is the core of the Finlay Vaccine Institute's data ecosystem: a platform that centralizes, normalizes and exploits the information generated across a vaccine's life cycle, from preclinical research to post-registration follow-up.",
      },
      {
        es: "El sistema combina agentes de lenguaje coordinados mediante grafos de estado (LangGraph) con recuperación aumentada por generación (RAG) sobre el corpus documental regulatorio y científico de la institución, de modo que los equipos puedan consultar en lenguaje natural protocolos, informes y resultados históricos.",
        en: "The system combines language agents coordinated through state graphs (LangGraph) with retrieval-augmented generation (RAG) over the institution's regulatory and scientific document corpus, so that teams can query protocols, reports and historical results in natural language.",
      },
      {
        es: "Sobre esa base se ejecutan flujos de AutoML que entrenan y comparan modelos predictivos de forma reproducible, con seguimiento de experimentos y validación estadística, para apoyar decisiones en el diseño de ensayos clínicos.",
        en: "On top of that foundation, AutoML flows train and compare predictive models reproducibly, with experiment tracking and statistical validation, to support decision-making in clinical trial design.",
      },
    ],
    role: { es: "Especialista Consultor — Diseño y desarrollo", en: "Consultant Specialist — Design and development" },
    contribution: {
      es: "Diseño de la arquitectura del ecosistema de datos, implementación del sistema multiagente y de los pipelines RAG, e integración de los flujos AutoML.",
      en: "Design of the data ecosystem architecture, implementation of the multi-agent system and RAG pipelines, and integration of the AutoML flows.",
    },
    technologies: ["Python", "LangGraph", "RAG", "AutoML", "Multiagentes", "PostgreSQL"],
    stack: [
      { group: { es: "IA y agentes", en: "AI & agents" }, items: ["LangGraph", "LangChain", "LLMs", "Embeddings", "Vector stores"] },
      { group: { es: "Machine Learning", en: "Machine Learning" }, items: ["AutoML", "scikit-learn", "SHAP", "Optuna"] },
      { group: { es: "Backend y datos", en: "Backend & data" }, items: ["Python", "FastAPI", "PostgreSQL", "Pandas"] },
    ],
    features: [
      {
        title: { es: "Sistema multiagente", en: "Multi-agent system" },
        description: {
          es: "Agentes especializados coordinados por grafos de estado que resuelven consultas complejas descomponiéndolas en subtareas.",
          en: "Specialized agents coordinated by state graphs that solve complex queries by decomposing them into subtasks.",
        },
      },
      {
        title: { es: "RAG sobre corpus regulatorio", en: "RAG over regulatory corpus" },
        description: {
          es: "Recuperación semántica sobre protocolos, informes y normativa, con respuestas ancladas en las fuentes originales.",
          en: "Semantic retrieval over protocols, reports and regulations, with answers grounded in the original sources.",
        },
      },
      {
        title: { es: "AutoML reproducible", en: "Reproducible AutoML" },
        description: {
          es: "Entrenamiento y comparación automática de modelos con seguimiento de experimentos y validación estadística.",
          en: "Automated model training and comparison with experiment tracking and statistical validation.",
        },
      },
    ],
    category: "ai",
  ...
  },
  {
    ...
    overview: [
      {
        es: "Los modelos compartimentales clásicos (SIR, SEIR) describen bien la dinámica de una epidemia pero dependen de parámetros fijos que rara vez capturan la heterogeneidad real de la población. Los modelos puramente estadísticos, en cambio, ajustan bien los datos pero no respetan la mecánica de la transmisión.",
        en: "Classical compartmental models (SIR, SEIR) describe epidemic dynamics well but depend on fixed parameters that rarely capture real population heterogeneity. Purely statistical models, in contrast, fit the data well but do not respect transmission mechanics.",
      },
      {
        es: "Este trabajo propone un enfoque híbrido: la estructura del sistema de ecuaciones diferenciales se conserva como esqueleto mecanicista, mientras que componentes de aprendizaje automático estiman parámetros dependientes del tiempo y del contexto. El resultado mantiene la interpretabilidad epidemiológica y gana capacidad de ajuste.",
        en: "This work proposes a hybrid approach: the differential-equation system's structure is kept as a mechanistic skeleton, while machine-learning components estimate time- and context-dependent parameters. The result preserves epidemiological interpretability while gaining fitting power.",
      },
      {
        es: "Se aplicó al estudio de la transmisión de la leptospirosis y a la evaluación comparativa de estrategias de vacunación, cuantificando el impacto esperado de distintas coberturas y calendarios.",
        en: "It was applied to the study of leptospirosis transmission and to the comparative evaluation of vaccination strategies, quantifying the expected impact of different coverage levels and schedules.",
      },
    ],
    role: { es: "Investigador — Modelado y desarrollo", en: "Researcher — Modeling and development" },
    technologies: ["Python", "EDO/SEIR", "Machine Learning", "SciPy", "Epidemiología"],
    stack: [
      { group: { es: "Modelado", en: "Modeling" }, items: ["EDO", "SEIR", "SciPy", "NumPy"] },
      { group: { es: "Machine Learning", en: "Machine Learning" }, items: ["scikit-learn", "Optimización de parámetros"] },
    ],
    category: "health",
    visibility: "private",
    organization: "Instituto Finlay de Vacunas · BioCubaFarma",
  ...
  },
  {
    ...
    overview: [
      {
        es: "En un ensayo clínico, cada dato registrado debe poder rastrearse hasta su origen y toda modificación debe quedar documentada. AuditSoft automatiza esa verificación sobre las bases de datos de ensayos del Instituto Finlay de Vacunas.",
        en: "In a clinical trial, every recorded data point must be traceable to its origin and every modification must be documented. AuditSoft automates that verification over the Finlay Vaccine Institute's trial databases.",
      },
      {
        es: "El sistema aplica reglas de validación configurables sobre los conjuntos de datos, detecta inconsistencias, valores fuera de rango y discrepancias entre fuentes, y genera informes de auditoría con la evidencia asociada a cada hallazgo.",
        en: "The system applies configurable validation rules over the datasets, detects inconsistencies, out-of-range values and cross-source discrepancies, and generates audit reports with the evidence attached to each finding.",
      },
    ],
    role: { es: "Desarrollador principal", en: "Lead developer" },
    technologies: ["Python", "FastAPI", "PostgreSQL", "Auditoría de datos"],
    stack: [
      { group: { es: "Backend", en: "Backend" }, items: ["Python", "FastAPI", "SQLAlchemy"] },
      { group: { es: "Datos", en: "Data" }, items: ["PostgreSQL", "Pandas", "Reglas de validación"] },
    ],
    category: "health",
    visibility: "private",
    organization: "Instituto Finlay de Vacunas · BioCubaFarma",
  ...
  },
  {
    ...
    overview: [
      {
        es: "ML Studio es un entorno de modelado end-to-end construido sobre el registro de pacientes con infarto agudo de miocardio. Automatiza la selección de algoritmos y el ajuste de hiperparámetros mediante AutoML (FLAML), evitando el sesgo de elegir manualmente un único modelo.",
        en: "ML Studio is an end-to-end modeling environment built on the acute myocardial infarction patient registry. It automates algorithm selection and hyperparameter tuning through AutoML (FLAML), avoiding the bias of manually choosing a single model.",
      },
      {
        es: "Cada modelo se acompaña de un análisis de interpretabilidad con SHAP, que cuantifica la contribución de cada variable clínica a la predicción individual — un requisito indispensable para que un modelo pueda discutirse con personal médico.",
        en: "Each model is paired with a SHAP interpretability analysis quantifying every clinical variable's contribution to the individual prediction — an indispensable requirement for a model to be discussed with medical staff.",
      },
      {
        es: "El módulo de optimización inversa recorre el espacio de variables modificables para identificar qué combinaciones de valores clínicos reducirían el riesgo estimado, ofreciendo una lectura accionable del modelo.",
        en: "The inverse optimization module explores the space of modifiable variables to identify which combinations of clinical values would reduce the estimated risk, providing an actionable reading of the model.",
      },
    ],
    role: { es: "Desarrollador e investigador", en: "Developer and researcher" },
  ...
  },
  {
    ...
    stack: [
      ...
      { group: { es: "Infraestructura", en: "Infrastructure" }, items: ["FastAPI", "Celery", "Redis"] },
    ],
    category: "simulation",
    visibility: "private",
  ...
  },
  {
    ...
    overview: [
      {
        es: "El modelo de datos cubre el ciclo completo del ensayo: reclutamiento y consentimiento informado, aleatorización y cegamiento, calendario de dosis, visitas de seguimiento, determinaciones de laboratorio y registro de eventos adversos con su clasificación de severidad y causalidad.",
        en: "The data model covers the trial's full cycle: recruitment and informed consent, randomization and blinding, dosing schedule, follow-up visits, laboratory determinations, and adverse event logging with severity and causality classification.",
      },
      {
        es: "El diseño se normalizó hasta tercera forma normal para eliminar redundancias que comprometerían la integridad de los datos, y se complementó con restricciones de integridad referencial y tablas de auditoría que preservan la trazabilidad exigida por la normativa regulatoria.",
        en: "The design was normalized to third normal form to eliminate redundancies that would compromise data integrity, complemented with referential integrity constraints and audit tables that preserve the traceability required by regulatory standards.",
      },
    ],
    role: { es: "Diseñador de base de datos", en: "Database designer" },
...
serializers/                  Transformación req/resp`,
  ...
  },
  {
    ...
    category: "web",
    visibility: "public",
    github: "https://github.com/Pol472/MoogleX",
  ...
  },
  {
    ...
    category: "compilers",
    visibility: "public",
    github: "https://github.com/Pol472/HULK",
  ...
  },
  {
    ...
    category: "systems",
    visibility: "public",
    github: "https://github.com/Pol472/Microprocesador-32-bits",
  ...
  },
  {
    ...
    category: "systems",
    visibility: "public",
    github: "https://github.com/Pol472/Tarea-Evaluativa-AC",
    course: { es: "Arquitectura de Computadoras", en: "Computer Architecture" },
    featured: false,
    year: "2024",
    status: "completed",
...
/* ------------------------------------------------------------
   ...
   edited through the admin UI, so galleries and extended
   descriptions can be updated without touching this file.
   ------------------------------------------------------------ */
